...
export default class BiPspbWapiQuestionnaire extends LightningElement {
	...
	*/
	...
	deleteSelectedResponses(recordIdsToDelete) {
		if (recordIdsToDelete.length > 0) {
			DELETE_SELECTED_RESPONSE({ idOfRes: recordIdsToDelete })
				...
				.catch((error) => {
					this.showToast(labels.ERROR_VARIANT, error.body.message, labels.ERROR_VARIANT);
				});
		}
	}
	...
	prepareResponseArrays() {
		// if(this.firstNumberValue ===0)
		// {
		// 	console.log('1');
		// 	this.secondRspValue=0;
		// }
		// if(this.secondNumberValue ===0)
		// {
		// 	console.log('2');
		// 	this.thirdRspValue=0;
		// }
		// if(this.thirdNumberValue ===0)
		// {
		// 	console.log('3');
		...
		if (this.firstNumberValue !== '') {
			console.log('the secondRspValue',this.secondRspValue);
			console.log('the secondRespVersId',this.secondRespVersId);
		...
		if (this.secondNumberValue !== '') {
			console.log('the thirdRspValue',this.thirdRspValue);
			console.log('the thirdVersionId',this.thirdVersionId);
			...
			console.log('why here2');
			this.realRespArray.push(this.thirdDraftResp);
			this.realAssesVerArra.push(this.thirdDraftVersionId);
		}
		if (this.thirdNumberValue !== '') {
			console.log('the fourthRspValue',this.fourthRspValue);
			console.log('the fourthVersionId',this.fourthVersionId);
		...
		if (this.sixthResponseValue !== '') {
			...
			console.log('this.sixthDraftResp',this.sixthDraftResp);
